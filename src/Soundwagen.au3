...
$GUI = GUICreate("Soundwagen in Zugverbände einfügen", 500, 330, -1, -1, BitOR($WS_MINIMIZEBOX,$WS_SIZEBOX,$WS_THICKFRAME,$WS_SYSMENU,$WS_CAPTION,$WS_POPUP,$WS_POPUPWINDOW,$WS_GROUP,$WS_BORDER,$WS_CLIPSIBLINGS))
$LabelZVLoad = GUICtrlCreateLabel("Zugverband laden:", 10, 12, 94, 17)
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
$InputZVLoad = GUICtrlCreateInput("", 110, 10, 345, 21)
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKRIGHT+$GUI_DOCKTOP+$GUI_DOCKHEIGHT)
$ButtonZVLoad = GUICtrlCreateButton("...", 465, 8, 25, 25, 0)
GUICtrlSetResizing(-1, $GUI_DOCKRIGHT+$GUI_DOCKTOP+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
$List1 = GUICtrlCreateList("", 10, 40, 480, 175, BitOR($LBS_SORT,$LBS_NOINTEGRALHEIGHT,$LBS_MULTICOLUMN,$WS_BORDER))
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKRIGHT+$GUI_DOCKTOP+$GUI_DOCKBOTTOM)
GUICtrlSetTip(-1, "Einen Soundwagen auswählen und Rechtsklicken, um die Sounds anzuhören")
$Label1 = GUICtrlCreateLabel("Nach jedem", 10, 227, 61, 17)
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKBOTTOM+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
$Input1 = GUICtrlCreateInput("1", 75, 225, 37, 21, BitOR($ES_RIGHT,$ES_AUTOHSCROLL))
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKBOTTOM+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
$Updown1 = GUICtrlCreateUpdown($Input1, 0)
GUICtrlSetLimit(-1, 10, 1)
$Label2 = GUICtrlCreateLabel(". Wagen einen Soundwagen einfügen", 115, 227, 184, 17)
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKBOTTOM+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
$LabelZVSave = GUICtrlCreateLabel("Zugverband speichern:", 10, 257, 114, 17)
GUICtrlSetResizing(-1, $GUI_DOCKLEFT+$GUI_DOCKBOTTOM+$GUI_DOCKWIDTH+$GUI_DOCKHEIGHT)
$InputZVSave = GUICtrlCreateInput("", 130, 255, 325, 21)
